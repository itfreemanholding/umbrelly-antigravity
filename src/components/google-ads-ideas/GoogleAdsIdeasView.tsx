...
import { MousePointerClick, Copy, Trash2, Calendar, Check, MessageSquare } from 'lucide-react';

export interface SavedGoogleAdsIdea {
    id: string;
    strategy: string;
    customPrompt: string;
...
interface GoogleAdsIdeasViewProps {
    ideas: SavedGoogleAdsIdea[];
    onDeleteIdea: (id: string) => void;
}

export const GoogleAdsIdeasView: React.FC<GoogleAdsIdeasViewProps> = ({ ideas, onDeleteIdea }) => {
    ...
    return (
        <div className="google-ads-ideas-view" style={{ maxWidth: '1200px', margin: '0 auto', animation: 'fadeIn 0.4s ease-out' }}>
            <div style={{ marginBottom: '32px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <div>
                    <h2 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        Google Ads Ideas History
                    </h2>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '15px', lineHeight: '1.6' }}>
                        A permanent library of all your AI-generated Google Ads strategies. Review, copy, or delete past generations.
                    </p>
                </div>
                <div style={{
                    ...
                    {ideas.length} Saved {ideas.length === 1 ? 'Strategy' : 'Strategies'}
                </div>
            </div>
            ...
            {ideas.length === 0 ? (
                <div className="glass-panel" style={{ padding: '64px 24px', textAlign: 'center' }}>
                    ...
                    <h3 style={{ fontSize: '18px', fontWeight: 600, marginBottom: '8px' }}>No Strategies Yet</h3>
                    <p style={{ color: 'var(--text-secondary)', maxWidth: '400px', margin: '0 auto' }}>
                        Head over to the Google Ads tab to synthesize your first batch of SEM keywords and ad copy.
                    </p>
                </div>
            ) : (
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px' }}>
                                ...
                                <div style={{ display: 'flex', gap: '8px' }}>
                                    <button
                                        ...
                                        title={copiedId === idea.id ? "Copied!" : "Copy Strategy"}
                                    >
